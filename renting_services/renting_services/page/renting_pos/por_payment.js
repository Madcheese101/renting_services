...
renting_services.PointOfRent.Payment = class {
	constructor({ events, wrapper , rent_allow_credit_sale}) {
		this.wrapper = wrapper;
		this.events = events;
		this.rent_allow_credit_sale = rent_allow_credit_sale;
		this.init_component();
	}
...
// was POS Invoice
		...
		this.$component.on('click', '.submit-order-btn', () => {
			...
			if (paid_amount == 0 && !me.rent_allow_credit_sale){
